      ...
      <section className="mx-auto max-w-7xl px-5 py-10">
        ...
        <div className="rounded-3xl bg-slate-950 p-7 text-white shadow-sm sm:p-10">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
            Manage your FamiNova account, profile and membership information
          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
            <div>
              ...
              <h2 className="mt-1 text-2xl font-bold text-slate-950">
                {membership?.membership_plans?.name || "No membership selected"}
              </h2>
              ...
              {membership?.membership_plans && (
                <p className="mt-2 text-sm text-slate-600">
                  ...
                  /{" "}
                  {membership.membership_plans.duration_months} month
                  {membership.membership_plans.duration_months > 1
                    ? "s"
                    : ""}
                </p>
              )}
          ...
          {membership?.status === "pending" && (
            <div className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-amber-800">
                Your membership selection has been recorded. Payment has not
                been collected and your membership has not yet been activated.
              </p>
            </div>
          )}
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              View available membership plans and your current membership
              status.
            </p>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Your account authentication is managed through Supabase
              Authentication.
            </p>
        ...
        <div className="mt-8 rounded-3xl border border-slate-200 bg-white p-7 shadow-sm sm:p-8">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-600">
            ...
            services only. Membership does not itself purchase or guarantee
            donor material, donor matching, medical treatment, pregnancy,
            biological material, or any specific fertility outcome.
          </p>
